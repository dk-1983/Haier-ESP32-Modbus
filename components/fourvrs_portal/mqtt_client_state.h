...
struct MqttConfig {
  uint32_t magic{0x484d5101};uint16_t port{1883};uint8_t enabled{0},reserved{0};
  char host[128]{},username[65]{},password[129]{},prefix[65]{};
};
struct MqttPublish {char topic[128]{};char payload[1536]{};};
...
struct MqttRuntime {
  ...
  std::atomic<bool> connected{false},applying{true};std::atomic<uint32_t> connections{0},dropped{0};
