...
haier_protocol::HaierMessage HonClimate::get_control_message() {
  ...
  if (bridge_mask_) hon_protocol::apply_bridge_control(*out_data, bridge_next_, bridge_mask_);
