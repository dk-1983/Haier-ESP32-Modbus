...
class HonClimate : public HaierClimateBase {
 ...
 public:
  ...
  // Bridge extension: preserve separate YCJ power/mode semantics and expose remote lock.
  void set_bridge_overrides(const hon_protocol::HaierPacketControl &next, uint16_t mask) {
    bridge_next_=next;bridge_mask_=mask;force_send_control_=true;
  }
  void clear_bridge_overrides(){bridge_mask_=0;}
 ...
 protected:
  ...
  hon_protocol::HaierPacketControl bridge_next_{};
  uint16_t bridge_mask_{0};
