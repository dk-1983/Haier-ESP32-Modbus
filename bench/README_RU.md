...
Используем два независимых канала из [схемы](../docs/PC817-UART-BENCH_RU.md), PC817 или проверенные по распиновке NEC PS2561-1:
