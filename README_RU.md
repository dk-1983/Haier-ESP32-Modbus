...
Назначение сигнальных проводов подтверждено автором сборки; **TX/RX обозначены со стороны платы Haier**:
...
Цвета относятся к этому жгуту, а не к универсальной распиновке всех Haier. Питание и землю подключают по проверенной схеме; по фото и рендеру не определяются артикул разъёма и шаг контактов.
