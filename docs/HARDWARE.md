...
MAX485: DI (4) ← GPIO15; RO (1) → делитель → GPIO16; DE (3) и /RE (2) вместе ← GPIO21; подтяжка GPIO21 10 кОм к GND. Питание MAX485 — 5 В. Прямое управление входами DI/DE допустимо лишь при соблюдении порогов конкретного трансивера; выход RO согласуется отдельно. Физический канал проверен на 19200 8N1 через шлюз TCP/RTU и клиентскую программу.
