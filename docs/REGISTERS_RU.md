...
Для Home Assistant доступен готовый профиль **4VRS Haier-ESP32** в [Modbus Devices 1.3.0 и новее](https://github.com/dk-1983/Modbus_Devices/blob/main/README_RU.md#4vrs). Он использует базовые и дополнительные регистры этой прошивки для климата, жалюзи, пресетов, тихого режима, дисплея и диагностики. Отдельный профиль **Haier YCJ-A002** сохранён для заводского адаптера. [Как подключить наш контроллер](../README_RU.md#готовая-интеграция-с-home-assistant).
