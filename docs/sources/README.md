...
Neither document defines a full mapping from hOn fault numbers to YCJ fault numbers or a rounding rule for half-degree temperature. Those implementation differences are explicitly documented in [REGISTERS.md](../REGISTERS.md).
