...
Формат status в этой конфигурации: 2 байта подкоманды, 10 байт control, минимум 22 байта sensors; status_message_header_size=0. Для другой модели формат следует подтвердить до использования.
