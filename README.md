...
- Локальный веб-пульт: температура, режим, вентилятор, обе оси жалюзи, турбо/сон, тихий режим, дисплей и фиксированные положения жалюзи.
...
- MQTT-клиент внешнего брокера через Wi-Fi: состояние, команды, Last Will и отдельный выключатель на `/mqtt`.
